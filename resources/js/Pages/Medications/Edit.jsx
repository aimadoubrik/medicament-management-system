...
export default function Edit({ medication, suppliers }) {
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Edit Medication</h1>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="overflow-hidden bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className="flex items-center justify-between px-6 py-4 border-t bg-gray-50 dark:bg-gray-800 dark:border-gray-600">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="flex items-center gap-1 px-6 py-2 text-white bg-green-600 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 dark:bg-green-700 dark:hover:bg-green-800"
                            >
                                <Save size={16} />
