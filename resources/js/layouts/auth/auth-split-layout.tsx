        ...
        <div className="relative grid min-h-dvh lg:grid-cols-2">
                ...
                {quote && (
                    <div className="relative z-20 mt-auto">
                        <blockquote className="space-y-3">
                            ...
                            <footer className="text-sm font-medium text-neutral-200">— {quote.author}</footer>
                        </blockquote>
                    </div>
                )}
            </div>
            ...
            <div className="flex items-center justify-center p-6 lg:p-12">
                <div className="w-full max-w-[400px] space-y-8">
                    {/* Mobile Logo */}
                    <Link href={route('home')} className="relative z-20 mb-8 flex items-center justify-center lg:hidden">
                    ...
                    <div className="flex flex-col items-start gap-3 text-left sm:items-center sm:text-center">
                        ...
                        <p className="text-muted-foreground text-base leading-relaxed text-balance">{description}</p>
                    </div>
